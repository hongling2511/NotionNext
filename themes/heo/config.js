const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-12-01', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.hongling.pro' },
    { title: '访问文档中心获取更多帮助', url: 'https://docs.hongling.pro' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '认识自己',
  HERO_TITLE_2: '理解世界',
  HERO_TITLE_3: '做一个内心平静和坚韧的人',
  HERO_TITLE_4: '赚钱之道',
